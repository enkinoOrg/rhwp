...
원본 `@rhwp/editor` npm package에는 발행하지 않습니다. iframe 메시지 origin/source 검증, 요청 정리, transferable 바이너리 계약이 반영된 Enkino 자체 SDK 기준은 고정 커밋 `9fc2bcbda1f5787c60b89244d01b4ff80e3adeab`입니다.
